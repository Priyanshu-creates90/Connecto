...
const EditProfile = () => {
  ...
  return (
    <div className="w-full max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
      <section className="flex flex-col gap-4 sm:gap-6 w-full py-6 sm:py-8">
        <h1 className="font-bold text-lg sm:text-xl">Edit Profile</h1>
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between bg-gray-100 rounded-xl p-4 gap-4">
